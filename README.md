...
The SSL is trained and evaluated on our [LIP dataset](http://hcp.sysu.edu.cn/lip/) for human parsing, or [Alternate Address](222.200.181.224/lip).  Please check it for more model details.
